...
public class FormElementPickerTime extends BaseFormElement {
    ...
    public FormElementPickerTime setTitleColor(int color) {
        return (FormElementPickerTime) super.setTitleColor(color);
    }

    public FormElementPickerTime setValueColor(int color) {
